        ...
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          {isNewConversation && !isLoading && workspaceContext && !workspaceContext.productDetails?.vision && !workspaceContext.productDetails?.key_objectives && (
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-xl border border-amber-500/30 bg-amber-500/5 hover:bg-amber-500/10 transition-colors text-left mb-4 animate-in fade-in slide-in-from-bottom-2 duration-300"
            >
